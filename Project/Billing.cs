    ...
    public partial class Billing : Form
    {
        ...
        private void ConfirmBill(string opt)
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@custid", int.Parse(custCb.Text));
                cmd.Parameters.AddWithValue("@date", DateTime.Now.ToString(@"yyyy-MM-dd"));
                cmd.Parameters.AddWithValue("@amount", Convert.ToDouble(TotalAmountLbl.Text));
               // cmd.Transaction = transaction;
                ...
                for (int i = 0; i < BillGdv.Rows.Count; i++)
                    ...
                    con.Open();
                        ...
                        cmd.Parameters.AddWithValue("@quan", qantity);
                  //      cmd.Transaction = transaction;
                        cmd.ExecuteNonQuery();
                    con.Close();
                }
